...
### 4. Research Using Context7 MCP

Use the Context7 MCP server to get:

- Code samples and examples for libraries and frameworks
- Best practices and usage patterns
- Latest stable versions and documentation

### 5. Research Using Official Docs (If Needed)

If information is not found via Context7, consult official documentation:

- **Vercel Docs** - Hosting, serverless functions, edge runtime, environment variables
- **Firebase Docs** - Auth, Firestore, Storage, security rules
- **Library docs** - Framework-specific patterns and API references
